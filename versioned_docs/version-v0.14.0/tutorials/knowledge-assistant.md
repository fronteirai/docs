...
Fronteir AI makes it easy to create a project that can answer questions about a set of documents using its built-in RAG (Retrieval-Augmented Generation) feature.
...
Start by going to the Fronteir AI homepage. Click on your profile picture in the top right and chose **Chat** from the dropdown.
