...
Fronteir AI is an open-source MCP Gateway and AI platform that can be deployed in the cloud or on-prem.

## Getting Started

To quickly try a live demo of the Fronteir AI MCP Gateway and chat experience, visit [https://chat.obot.ai](https://chat.obot.ai).

You can use Docker to quickly spin up the Fronteir AI MCP Gateway server locally to try out the full capabilities. Using something like [Docker Desktop](https://docs.docker.com/get-started/introduction/get-docker-desktop/). Once that’s ready, run:
...
Then open your browser to [http://localhost:8080](http://localhost:8080) to access the Fronteir AI UI.

> **Note:** The Docker command above is intended for local testing and evaluation only. For production deployments, we recommend running Fronteir AI on Kubernetes. See our [Installation Guide](/installation/overview) for detailed production setup instructions.
...
## The Three Parts of Fronteir AI
...
- **Broad Client Support** – Connect with local clients such as Claude Desktop and VS Code or use our hosted Fronteir AI Chat
...
- **Server Deployment and Hosting** - Let Fronteir AI deploy and host MCP servers to ease your operational burden
...
1. **Users** interact with Fronteir AI projects through the **Chat Interface** and MCP Servers through the **MCP Gateway**.
