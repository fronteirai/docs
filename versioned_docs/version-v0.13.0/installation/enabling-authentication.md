...
By default, Fronteir AI runs without authentication in development mode. For production deployments, you'll need to:
...
When Fronteir AI starts with authentication enabled for the first time, it generates a bootstrap token that's printed to the console logs. 
...
1. Navigate to your Fronteir AI installation
...
Logout of Fronteir AI and configure the following.
...
After setting the environment variables, restart your Fronteir AI deployment:
