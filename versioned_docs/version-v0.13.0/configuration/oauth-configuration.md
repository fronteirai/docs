...
2. Get a token you can use to interact with the Fronteir AI API: `OBOT_BASE_URL=<obot host>/api obot token`. If Fronteir AI is running at `localhost:8080`, then you can leave off the `OBOT_BASE_URL` part.
