...
Fronteir AI can export audit logs to various cloud storage providers for long-term retention. This feature supports both one-time exports and scheduled recurring exports.
...
4. **Test Connection**:
   ...
   - This ensures Fronteir AI can successfully connect to your storage
...
Use the identity associated with your Fronteir AI deployment. This method is more secure as it doesn't require storing explicit credentials.
