# Fronteir AI's Open Source Registry
Each Fronteir AI instance connects to our open source registry by default. You can follow this guide to add your MCP server to [Fronteir AI's registry](https://github.com/obot-platform/mcp-catalog). You'll either submit **just a catalog entry**, or **a catalog entry + a repackaged image** (for containerized servers).
...
### Test with Fronteir AI running Locally

If you have Fronteir AI running locally, you can test your catalog entry before submitting:

1. When you run Fronteir AI locally, you'd need to set this env variable `OBOT_SERVER_DEFAULT_MCPCATALOG_PATH` to the absolute path of your local mcp-catalog fork.
2. Add your YAML to your local Fronteir AI catalog directory
