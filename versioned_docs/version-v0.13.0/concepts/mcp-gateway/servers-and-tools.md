...
Connectors are services that implement the Model Context Protocol, providing tools and resources that AI can use. Understanding how connectors work is essential for extending Fronteir AI's capabilities and integrating with external systems.
...
MCP servers deployed as containers in Fronteir AI's infrastructure:
