...
1. **Create or Fork a Repository**: Start with the official [Fronteir AI MCP catalog](https://github.com/obot-platform/mcp-catalog) or create your own repository
2. **Add Server Configurations**: Create YAML files for each MCP server following the catalog format (see examples below)
3. **Configure Fronteir AI**: Point your Fronteir AI instance to the Git repository containing your catalog
...
For examples and reference implementations, see the official Fronteir AI MCP catalog at [github.com/obot-platform/mcp-catalog](https://github.com/obot-platform/mcp-catalog).
