...
By default, Fronteir AI Agent uses storage inside its pod, which means all agent state is lost if the pod restarts. For production deployments, it's recommended to configure persistence.
