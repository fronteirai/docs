...
Fronteir AI uses role-based access control to manage what users can do in the MCP Platform. Each role has different permissions and sees different parts of the interface.
...
Full platform management: MCP Management, Fronteir AI Agent Management, User Management, and App Preferences. Cannot assign the Owner or Auditor roles.
...
Connect to MCP servers, use Fronteir AI Agent, and create conversations and workflows.
...
| Use Fronteir AI Agent | Yes | Yes | Yes | Yes | Yes   |
...
| Fronteir AI Agent Management | | | | Yes | Yes   |
