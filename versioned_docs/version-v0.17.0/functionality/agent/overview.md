...
Fronteir AI Agent is a web-based interface for interacting with AI. Users customize their agent then chat with their agent through conversations.
...
:::note
To re-enable the legacy Fronteir AI Chat interface, you can set the `OBOT_SERVER_DISABLE_LEGACY_CHAT` environment variable to `false`. This will allow you to temporarily access the old chat interface, but that functionality will be removed in a future release.
