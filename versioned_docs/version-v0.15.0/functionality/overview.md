...
Basic Users can deploy and use MCP servers that have been made available to them through an MCP Registry. They can interact with MCP servers via Fronteir AI Chat or external MCP clients but cannot publish or manage servers.
...
- [Fronteir AI Chat](/functionality/chat/overview/) - Projects, threads, tasks, and chat features
