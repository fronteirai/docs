...
Fronteir AI supports encrypting sensitive data at rest in the database using industry-standard encryption providers. When enabled, encryption protects user data, credentials, OAuth tokens, session information, and other sensitive fields using external Key Management Services (KMS).

## Supported Encryption Providers

Fronteir AI supports the following encryption providers:
...
Fronteir AI uses the Kubernetes EncryptionConfiguration format to encrypt data at rest. The encryption provider:
