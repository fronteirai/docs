...
1. **Create or Fork a Repository**: Start with the official [Fronteir AI MCP server repository](https://github.com/obot-platform/mcp-catalog) or create your own
2. **Add Server Configurations**: Create YAML files for each MCP server following the format below
3. **Configure Fronteir AI**: Point your Fronteir AI instance to the Git repository containing your server configurations
...
For examples and reference implementations, see the official Fronteir AI MCP server repository at [github.com/obot-platform/mcp-catalog](https://github.com/obot-platform/mcp-catalog).
