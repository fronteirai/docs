...
Every MCP server runs with a shim. This includes servers deployed by Fronteir AI and remote MCP servers. The shim is protocol-aware and handles:
...
### With Fronteir AI Agent

Fronteir AI Agent connects through the gateway automatically. Users select which MCP servers to enable for their agents, conversations, or workflows.
